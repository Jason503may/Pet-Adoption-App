...
const Dogs = () => {
  ...
  const [tabValue, setTabValue] = useState('dog');
    ...
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      <Box sx={{ textAlign: 'center', mb: 4 }}>
        <Typography variant="h1" gutterBottom>
          {tabValue === 'dog' ? 'Find Your Perfect Dog' : 'Adorable Puppies'}
        </Typography>
        <Typography variant="h5" color="text.secondary" sx={{ mb: 3 }}>
          {tabValue === 'dog' ? 'Loyal companions waiting for their forever home' : 'Start your journey with a new furry friend'}
        </Typography>
      </Box>
